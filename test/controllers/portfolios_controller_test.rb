...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { about: @portfolio.about, client: @portfolio.client, completed: @portfolio.completed, name: @portfolio.name } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { about: @portfolio.about, client: @portfolio.client, completed: @portfolio.completed, name: @portfolio.name } }
